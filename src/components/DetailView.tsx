...
export default async function DetailView({ params, type }: { params: Promise<{ slug: string }>, type: string }) {
    ...
    }[type as 'courses' | 'workshops' | 'programs' | 'product'] || {
        accent: 'slate',
        from: 'from-slate-600',
        to: 'to-slate-700',
        bg: 'bg-slate-50',
            ...
            <div className="relative w-full h-[65vh] md:h-[75vh] overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 h-full flex flex-col justify-end pb-24">
                    <div className="flex flex-col lg:flex-row gap-12 items-end justify-between">
                        <div className="flex-grow max-w-4xl pt-20">


                            <h1
                                className="text-5xl md:text-7xl font-black text-white leading-[1.05] tracking-tight mb-8 drop-shadow-2xl"
                                dangerouslySetInnerHTML={{ __html: post.title.rendered }}
                            />

                            {/* Standard Info Bar (Hidden for workshops since we have the big widget, or keep small) */}
                            {type !== 'workshops' && (
                                <div className="flex flex-wrap gap-6 md:gap-10 items-center bg-white/10 backdrop-blur-md border border-white/20 p-3 pr-8 rounded-2xl shadow-2xl max-w-fit">
                                    <div className="flex items-center gap-4 pl-2">
                                        ...
                                        <div>
                                            <p className="text-[10px] font-bold text-blue-100 uppercase tracking-widest mb-0.5">Published</p>
                        ...
                        {type === 'workshops' && (
                            <div className="w-full lg:w-auto min-w-[320px] mb-8 lg:mb-0 animate-fade-in-up">
                                <div className="bg-slate-900/80 backdrop-blur-xl border border-white/20 rounded-3xl p-6 shadow-2xl ring-1 ring-white/10 relative overflow-hidden group hover:scale-[1.02] transition-transform duration-300">
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <button className="w-full py-4 bg-white text-slate-900 font-bold uppercase tracking-widest text-sm rounded-xl hover:bg-red-500 hover:text-white transition-all shadow-lg shadow-black/20 flex items-center justify-center gap-2 group-hover:shadow-red-500/20">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                    ...
                    <div className="lg:col-span-8 space-y-10">
                        ...
                        <div className="bg-white rounded-[2rem] p-8 md:p-12 shadow-xl border border-gray-100">
                            ...
                            <div className="prose prose-lg text-gray-600 leading-relaxed mb-8 max-w-none wordpress-content">
                                <div dangerouslySetInnerHTML={{ __html: overview }} />
                            </div>
                        </div>

                        {/* 2. Syllabus Timeline (Only if modules exist) */}
                        {modules.length > 0 && (
                            <div className="bg-white rounded-[2rem] p-8 md:p-12 shadow-xl border border-gray-100 overflow-hidden">
                                <h2 className="text-3xl font-black text-gray-900 mb-10">Program Syllabus</h2>
                                <div className="relative pl-8 border-l-2 border-gray-100 space-y-12">
                                    {modules.map((item, i) => (
                                        <div key={i} className="relative">
                                            {/* Timeline Dot */}
                                            <div className={`absolute -left-[41px] top-1 w-5 h-5 rounded-full border-4 border-white ${branding.bg.replace('50', '500')} shadow-md`}></div>

                                            <span className={`text-xs font-black uppercase tracking-widest ${branding.text} mb-2 block`}>Module {i + 1}</span>
                                            <h3 className="text-xl font-bold text-gray-900 mb-2">{item.title}</h3>
                                            <div className="text-gray-500 prose prose-sm max-w-none wordpress-content" dangerouslySetInnerHTML={{ __html: item.content }} />
                                        </div>
                                    ))}
                                </div>
                            </div>
                        ...
                        <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-[2rem] p-8 md:p-12 shadow-2xl text-white relative overflow-hidden">
                            ...
                            <div className="relative z-10 flex flex-col md:flex-row gap-8 items-center md:items-start text-center md:text-left">
                                <div className="w-24 h-24 rounded-full bg-slate-700 border-4 border-slate-600 flex-shrink-0 overflow-hidden">
                                    <Image src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&q=80&w=200" width={200} height={200} className="w-full h-full object-cover" alt="Instructor" />
                                </div>
                                <div>
                                    <h2 className="text-2xl font-bold mb-2">Lead Instructor</h2>
                                    <h3 className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-white mb-4">Dr. Sarah Chen</h3>
                    ...
                    <div className="lg:col-span-4">
                        <div className="sticky top-24 space-y-8">
                            ...
                            <div className="bg-white rounded-[2.5rem] p-8 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.12)] border border-gray-100 relative overflow-hidden group">
                                {/* Soft ambient glow */}
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="space-y-5 mb-10">
                                        <div className="flex items-center justify-between p-3 rounded-2xl bg-gray-50 group-hover:bg-white border border-transparent group-hover:border-gray-100 transition-all">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="flex flex-col">
                                                    ...
                                                    <span className="text-sm font-bold text-gray-900">Live + Recorded</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="flex items-center justify-between p-3 rounded-2xl bg-gray-50 group-hover:bg-white border border-transparent group-hover:border-gray-100 transition-all">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="flex flex-col">
                                                    ...
                                                    <span className="text-sm font-bold text-gray-900">8 Weeks</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="flex items-center justify-between p-3 rounded-2xl bg-gray-50 group-hover:bg-white border border-transparent group-hover:border-gray-100 transition-all">
                                            <div className="flex items-center gap-3">
                                                <div className={`w-10 h-10 rounded-xl bg-white shadow-sm flex items-center justify-center text-lg`}>📜</div>
                                                <div className="flex flex-col">
                                                    <span className="text-xs font-bold text-gray-400 uppercase tracking-wide">Certification</span>
                                    ...
                                    <div className="space-y-4">
                                        <a
                                            href={`https://nanoschool.in/${type}/${slug}`}
                                            target="_blank"
                                            className={`flex items-center justify-center w-full py-5 bg-gradient-to-r ${branding.from} ${branding.to} text-white font-black uppercase tracking-[0.15em] rounded-2xl shadow-xl ${branding.shadow} hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 active:scale-95 text-sm relative overflow-hidden`}
                                        >
                            ...
                            <div className="bg-white rounded-[2rem] p-8 shadow-xl border border-gray-100 relative overflow-hidden group">
                                ...
                                <p className="text-sm text-gray-500 mb-6 leading-relaxed">Not sure if this course is right for you? Schedule a free 15-minute consultation with our academic advisors.</p>
